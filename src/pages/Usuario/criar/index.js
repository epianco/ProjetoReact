                ...
                <form onSubmit={this.handleSubmit}>
                    <fieldset>
                        ...
                        <div className="usuario-insert">
                            ...
                            <br />
                            <input type="text" id="salario" name="salario" placeholder="Salário" required
                        ...
                        <div className="usuario-insert">
                            ...
                            <label>
                                <input type="radio" value="false" name="ativo" 
                        ...
                        <button type="submit" clasName="btn btn-primary"> Cadastrar</button>
                    </fieldset>
                </form>
            );
        }
