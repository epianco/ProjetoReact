...
class EditarUsuario extends Component {
                ...
                <form onSubmit={this.handleSubmit}>
                    <fieldset>
                        ...
                        <div className="usuario-update">
                            ...
                            <br />
                            <input type="text" id="salario" name="salario" placeholder="Mátricula" minLength="1" maxLength="99999" required
                        ...
                        <div className="usuario-update">
                            ...
                            <br />
                            <input type="text" id="dataNascimento" name="dataNascimento" placeholder="dataNascimento" required 
    ...
    handleSubmit = event => {
        ...
        fetch(`${process.env.REACT_APP_AzzPI_URL}/sistema/usuarios/${id}`, {
            method: "put",
